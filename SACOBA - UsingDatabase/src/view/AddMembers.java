...
public class AddMembers extends javax.swing.JFrame {
    ...
    private void addMember() {
        ...
        if (!regId.isEmpty() && !nameTxt.getText().isEmpty()&& !regId.equals("0000")) {
            if (checkAvailabal(regId)) {
                Members members = new Members(regId, nameTxt.getText(), "", noTxt.getText(), areaTxt.getText(), cityTxt.getText());
    ...
    private void updateMember() {
        Members members = new Members(regNoTxt.getText(), nameTxt.getText(), "", noTxt.getText(), areaTxt.getText(), cityTxt.getText());
        MemberController memberController = new MemberController();
